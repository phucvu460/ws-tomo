...
class CollisionSceneExample(object):
    ...
    def __init__(self):
        ...
        rospy.sleep(2)
    def add_rings(self):
        box1_pose = [330*10**(-3),110*10**(-3),  0, 0, 0, 0, 1]
        box1_dimensions = [0.04, 0.04, 0.001]

        self.add_box_object("box1", box1_dimensions, box1_pose)

        print ("============ Added one obstacle to RViz!!")
    def add_one_box(self):
        box1_pose = [0.4, 0.15, 0, 0, 0, 0, 1]
        box1_dimensions = [0.3, 0.1, 0.26]
    ...
    def add_box_object(self, name, dimensions, pose):
        ...
        print("robot frame id",self.robot.get_planning_frame())
